...
bool GossipHello_custom_npc_spellmaster(Player* pPlayer, Creature* pCreature)
{
    ...
    bool LearnAllWeapons            = CUSTOMConfig.GetBoolDefault("Spellmaster.LearnAllWeapons", true);
    bool LearnAllLanguages          = CUSTOMConfig.GetBoolDefault("Spellmaster.LearnAllLanguages", true);
    bool MaxOutWeaponSkills         = CUSTOMConfig.GetBoolDefault("Spellmaster.MaxOutWeaponSkills", true);
    bool MaxOutRidingSkills         = CUSTOMConfig.GetBoolDefault("Spellmaster.MaxOutRidingSkills", true);
    bool MaxOutLanguageSkills       = CUSTOMConfig.GetBoolDefault("Spellmaster.MaxOutAllLanguageSkills", true);

    if(pPlayer->getLevel() > (CUSTOMConfig.GetFloatDefault("SpellMaster.MinimumLevel",0)))
    {
        // Warrior Spells
