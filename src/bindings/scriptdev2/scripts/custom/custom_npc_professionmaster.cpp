...
bool GossipHello_custom_npc_professionmaster(Player* pPlayer, Creature* pCreature)
{
	...
	bool ProfessionsEnabled = CUSTOMConfig.GetBoolDefault("ProfessionMaster.ProfessionsEnabled", true);
	bool SecondarySkillsEnabled = CUSTOMConfig.GetBoolDefault("ProfessionMaster.SecondarySkillsEnabled", true);
...
void SendDefaultMenu_custom_npc_professionmaster(Player* pPlayer, Creature* pCreature, uint32 uiAction)
{
    ...
    //Money Check
    if (pPlayer->GetMoney() < (CUSTOMConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)))
    {
        pPlayer->CLOSE_GOSSIP_MENU();
    ...
    switch(uiAction)
    {
        ...
        case 1001: // Alchemy
            ...
            {
            pPlayer->UpdateSkill(171,(CUSTOMConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(CUSTOMConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 1002: // Blacksmithing
            ...
            {
            pPlayer->UpdateSkill(164,(CUSTOMConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(CUSTOMConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 1003: // Enchanting
            ...
            {
            pPlayer->UpdateSkill(333,(CUSTOMConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(CUSTOMConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 1004: // Engineering
            ...
            {
            pPlayer->UpdateSkill(202,(CUSTOMConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(CUSTOMConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 1005: // Herbalism
            ...
            {
            pPlayer->UpdateSkill(182,(CUSTOMConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(CUSTOMConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 1006: // Inscription
            ...
            {
            pPlayer->UpdateSkill(773,(CUSTOMConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(CUSTOMConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 1007: // Jewelcrafting
            ...
            {
            pPlayer->UpdateSkill(755,(CUSTOMConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(CUSTOMConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 1008: // Leatherworking
            ...
            {
            pPlayer->UpdateSkill(165,(CUSTOMConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(CUSTOMConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 1009: // Mining
            ...
            {
            pPlayer->UpdateSkill(186,(CUSTOMConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(CUSTOMConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 1010: // Skinning
            ...
            {
            pPlayer->UpdateSkill(393,(CUSTOMConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(CUSTOMConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 1011: // Tailoring
            ...
            {
            pPlayer->UpdateSkill(197,(CUSTOMConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(CUSTOMConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 2001: // Cooking
            ...
            {
            pPlayer->UpdateSkill(185,(CUSTOMConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(CUSTOMConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 2002: // First Aid
            ...
            {
            pPlayer->UpdateSkill(129,(CUSTOMConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(CUSTOMConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 2003: // Fishing
            ...
            {
            pPlayer->UpdateSkill(356,(CUSTOMConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(CUSTOMConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
        ...
        case 2005: // Archaeology
            ...
            {
            pPlayer->UpdateSkill(794,(CUSTOMConfig.GetFloatDefault("ProfessionMaster.AddSkillPoints",0)));
            pPlayer->ModifyMoney(-(CUSTOMConfig.GetFloatDefault("ProfessionMaster.SkillPointCost",0)));
            pPlayer->CLOSE_GOSSIP_MENU();
            }
        break;
